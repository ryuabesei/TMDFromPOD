...
OUT_PNG      = Path("Figure/2018/2D_residual_SWARM-A_DOY20-80.png")

T_START = "2018-01-20 00:00:00"   # DOY 20
T_END   = "2018-03-21 23:59:59"   # DOY 80

SECTOR_MORNING = (7, 9)
SECTOR_EVENING = (18, 21)
...
# =========================
def main() -> None:
    print("Loading normalized data (SWARM-A, DOY 20-80) ...")
    ...
    fig.suptitle(
        ...
        "Reference: DOY 20–40 & 61–80 mean per latitude (non-SSW)",
    ...
    panels = [
        (0, Z_res_m, df_m, SECTOR_MORNING, "Residual (07–09 LT)"),
        (1, Z_res_e, df_e, SECTOR_EVENING, "Residual (18–21 LT)"),
    ]
    ...
    for col, Z_res, df_sec, sector, title in panels:
        ...
        # SSW期間をハイライト
        ax.axvspan(DOY_SSW_START, DOY_SSW_END, color="gold", alpha=0.20, lw=0,
