"""
1D_ratio_msis_2018_SWARM-B_by_LT.py

Purpose:
    Plot daily-median density_ratio_msis split by LT sector for SWARM-B.

    SWARM-B observes two LT sectors during DOY 30-65:
...
Output:
    Figure/2018/1D_ratio_msis_2018_SWARM-B_DOY30-65_by_LT.png
"""
...
OUT_PNG    = Path("Figure/2018/1D_ratio_msis_2018_SWARM-B_DOY30-65_by_LT.png")
...
def main() -> None:
    ...
    fig.suptitle(
        "SWARM-B  density_ratio_msis residual  (DOY 30-65, 2018)\n"
