"""
1D_residual_density_SWARM-A.py
...
Steps:
    ...
    2. Filter by lat (-60 to 60) and LT sector (Morning / Evening)
...
Output:
    Figure/2018/1D_residual_SWARM-A_DOY20-80.png
"""
...
OUT_PNG       = Path("Figure/2018/1D_residual_SWARM-A_DOY20-80.png")
...
def plot_residuals(
    ...
    sectors = [
        (axes[0], res_morning, ref_morning, "Morning (07–09 LT)", "#2A6AE0"),
        (axes[1], res_evening, ref_evening, "Evening (18–21 LT)", "#E05C2A"),
    ]
