...
目的:
    正規化前（integrateddata/swarm_dnsapod_2018.parquet）と
    正規化後（normalizeddata/swarm_dnsapod_2018_normalized.parquet）の
...
OUT_PNG = Path("Figure/swarm_dnsbpod_2018_before_after_normalization_DOY20-80_520km.png")
...
def main() -> None:
    ...
    fig.suptitle(
        "Swarm-B Thermospheric Mass Density (2018, DOY 20-80, alt ref=520 km)\n"
