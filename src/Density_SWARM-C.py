...
# 軸設定
ax1.set_title(f"Swarm-C normalized density ({SECTOR_LEFT[0]:02d}–{SECTOR_LEFT[1]:02d} LT)")
ax2.set_title(f"Swarm-C normalized density ({SECTOR_RIGHT[0]:02d}–{SECTOR_RIGHT[1]:02d} LT)")
