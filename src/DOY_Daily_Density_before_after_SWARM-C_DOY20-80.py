"""
DOY_Daily_Density_before_after_SWARM-C.py
...
線の構成:
    ① Raw observed density      : integrateddata/swarm_dnscpod_2018.parquet
    ② Normalized density        : normalizeddata/swarm_dnscpod_2018_normalized.parquet
    ③ MSIS reference density    : 基準条件（alt=450km, F10.7=70, Ap=4）で計算

出力:
    Figure/DailyDensity_before_after_SWARM-C.png
"""
...
# 設定
# =========================
RAW_PARQUET  = Path("integrateddata/swarm_dnscpod_2018.parquet")
NORM_PARQUET = Path("normalizeddata/swarm_dnscpod_2018_normalized.parquet")
OUT_PNG      = Path("Figure/DailyDensity_before_after_SWARM-C_DOY20-80.png")
...
ax.set_title(
    "Swarm-C: Daily Mean Density – Before vs After Normalization\n"
