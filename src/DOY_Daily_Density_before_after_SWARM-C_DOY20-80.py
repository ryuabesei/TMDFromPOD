...
線の構成:
    ① Raw observed density      : integrateddata/2018/swarm_dnscpod_2018.parquet
    ② Normalized density        : normalizeddata/2018/swarm_dnscpod_2018_normalized.parquet
    ③ MSIS reference density    : 基準条件（alt=450km, F10.7=70, Ap=4）で計算

出力:
    Figure/2018/DailyDensity_before_after_SWARM-C.png
"""
...
NORM_PARQUET = Path("normalizeddata/2018/swarm_dnscpod_2018_normalized.parquet")
OUT_PNG      = Path("Figure/2018/DailyDensity_before_after_SWARM-C_DOY20-80.png")
