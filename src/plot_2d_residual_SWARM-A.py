...
def main() -> None:
    ...
    fig.suptitle(
        "Swarm-A  Residual Normalized Density (DOY 36–52, 2018)\n"
    ...
    panels = [
        (0, Z_res_m, df_m, SECTOR_MORNING, f"Residual (07–09 LT)"),
        (1, Z_res_e, df_e, SECTOR_EVENING, f"Residual (18–21 LT)"),
    ]
    ...
    for col, Z_res, df_sec, sector, title in panels:
        ...
        ax.axvspan(DOY_REF_MIN, DOY_REF_MAX, color="white", alpha=0.15, lw=0,
                   label=f"Ref period (DOY {DOY_REF_MIN}–{DOY_REF_MAX})")
