...
KPINDEX_CSV = Path("data/SSW2018/Kpindex/SW-20180120_20180320.csv")
...
JOBS = [
    dict(
        ...
        out_parquet_lt_removed = Path("normalizeddata/2018/swarm_dnsapod_2018_normalized_with_LT_removed_DOY20-80.parquet"),
        alt_ref_km             = 450.0,
    ...
    dict(
        ...
        out_parquet_lt_removed = Path("normalizeddata/2018/swarm_dnsbpod_2018_normalized_with_LT_removed_DOY20-80.parquet"),
        alt_ref_km             = 450.0,
    ...
    dict(
        ...
        out_parquet_lt_removed = Path("normalizeddata/2018/swarm_dnsbpod_2018_normalized_with_LT_removed_DOY20-80(450km).parquet"),
        alt_ref_km             = 450.0,
    ...
    dict(
        ...
        out_parquet_lt_removed = Path("normalizeddata/2018/swarm_dnscpod_2018_normalized_with_LT_removed_DOY20-80.parquet"),
        alt_ref_km             = 450.0,
