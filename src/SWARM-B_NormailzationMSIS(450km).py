...
入力:
- integrateddata/2018/swarm_dnsbpod_2018.parquet
- data/Kpindex/SW-All.csv

出力:
- normalizeddata/2018/swarm_dnsbpod_2018_normalized.parquet
"""
...
# 入出力パス（ユーザー指定）
# =========================
SWARM_PARQUET = Path("integrateddata/2018/swarm_dnsbpod_2018.parquet")
KPINDEX_CSV   = Path("data/Kpindex/SW-All.csv")
OUT_PARQUET   = Path("normalizeddata/2018/swarm_dnsbpod_2018_normalized(450km).parquet")
