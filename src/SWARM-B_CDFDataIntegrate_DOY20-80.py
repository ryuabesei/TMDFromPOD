...
def read_swarm_dnsbpod(path: str) -> pd.DataFrame:
    cdf = CDF(path)
...
# 統合
print("Reading all CDF files for SWARM-B ...")
...
# 保存
out_path = Path("integrateddata/2018/swarm_dnsbpod_2018_DOY20-80.parquet")
