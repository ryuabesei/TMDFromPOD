...
目的:
    正規化前（integrateddata/2018/swarm_dnsbpod_2018_DOY20-80.parquet）と
    正規化後（normalizeddata/2018/swarm_dnsbpod_2018_normalized_DOY20-80.parquet）の
...
OUT_PNG      = Path("Figure/2018/swarm_dnsbpod_2018_before_after_normalization_DOY20-80_LT22-5_11-17_450km.png")
