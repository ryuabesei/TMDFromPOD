"""
plot_1D_delta_ratio_only_2019.py

Purpose:
    Plot daily-median delta_ratio (Residual = ratio - median(non-SSW ref)) as a 1D
    time series for the 2019 SH SSW period (2019-08-20 to 2019-09-23) [all LT, delta only].
...
Output:
    Figure/2019/1D_delta_ratio_only_msis_2019_SWARM-{A,B,C}.png
"""
...
def plot_job(job: dict) -> None:
    ...
    fig.suptitle(f"{label}  density_ratio_msis residual (2019 SH SSW)  [all LT]",
