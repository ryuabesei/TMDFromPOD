r"""
plot_2d_detrend_only_2018_2019_BC.py

Purpose:
    Same layout/method as 2D_detrend_only_temp_ap_YYYY.png
    (plot_2d_detrend_only_3years.py), but for SWARM-B and SWARM-C
    for the 2018 NH SSW and 2019 SH SSW events.

    Method (NO Kp filtering — regression over ALL days):
        - Linear regression: density_ratio_msis ~ a*Ap + b  (all days)
        - delta_y_ap = density_ratio_msis - (a*Ap + b)
        - 1D panel: delta_y_ap, T(10 hPa), Ap
        - 2D panel: pcolormesh of delta_y_ap (RdBu_r, ±0.20)

Output:
    Figure/Ap_removal/2D_detrend_only_temp_ap_2018_SWARM-B.png
    Figure/Ap_removal/2D_detrend_only_temp_ap_2018_SWARM-C.png
    Figure/Ap_removal/2D_detrend_only_temp_ap_2019_SWARM-B.png
    Figure/Ap_removal/2D_detrend_only_temp_ap_2019_SWARM-C.png
"""
...
EVENTS = [
    ...
    dict(
        ...
        x_interval=4,
        out_png=OUT_DIR / "2D_detrend_only_temp_ap_2018_SWARM-B.png",
    ),
    # ── 2018 NH SSW SWARM-C ──────────────────────────────────────────────────
    dict(
        ...
        x_label="Date 2018 (DOY 30-65)",
        x_interval=4,
        out_png=OUT_DIR / "2D_detrend_only_temp_ap_2018_SWARM-C.png",
    ),
    # ── 2019 SH SSW SWARM-B ──────────────────────────────────────────────────
    dict(
        ...
        x_interval=4,
        out_png=OUT_DIR / "2D_detrend_only_temp_ap_2019_SWARM-B.png",
    ),
    # ── 2019 SH SSW SWARM-C ──────────────────────────────────────────────────
    dict(
        ...
        x_label="Date 2019 (08/20 - 09/23)",
        x_interval=4,
        out_png=OUT_DIR / "2D_detrend_only_temp_ap_2019_SWARM-C.png",
    ),
]
...
def plot_event(ev: dict) -> None:
    ...
    print(f"  Regression (all days): a={slope:.5f}, b={intercept:.5f}, r={r:.3f}")
    ...
    # Align 1D panel width to 2D panel
    fig.canvas.draw()
