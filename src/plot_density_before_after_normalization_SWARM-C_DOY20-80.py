...
目的:
    正規化前（integrateddata/2018/swarm_dnscpod_2018_DOY20-80.parquet）と
    正規化後（normalizeddata/2018/swarm_dnscpod_2018_normalized_DOY20-80.parquet）の
...
# 設定
# =========================
RAW_PARQUET  = Path("integrateddata/2018/swarm_dnscpod_2018_DOY20-80.parquet")
NORM_PARQUET = Path("normalizeddata/2018/swarm_dnscpod_2018_normalized_DOY20-80.parquet")
OUT_PNG      = Path("Figure/2018/swarm_dnscpod_2018_before_after_normalization_DOY20-80_LT7-9_19-21.png")
...
def main() -> None:
    ...
    fig.suptitle(
        "Swarm-C Thermospheric Mass Density (2018, DOY 20–80)\n"
    ...
    panels = [
        ...
        (0, 1, "raw_e",  levels_raw,  "Before norm. (19–21 LT)", SECTOR_EVENING),
        (1, 0, "norm_m", levels_norm, "After norm. (07–09 LT)",  SECTOR_MORNING),
        (1, 1, "norm_e", levels_norm, "After norm. (19–21 LT)",  SECTOR_EVENING),
    ]
