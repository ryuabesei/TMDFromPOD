"""
plot_2d_raw_density_2018_SWARM-A.py

目的:
    raw（正規化前: integrateddata/2018/swarm_dnsapod_2018_DOY20-80.parquet）の
    2018年SSW時（DOY 20–80）における SWARM-A 質量密度の2D分布（緯度 × DOY）を
...
OUT_PNG = Path("Figure/2018/swarm_dnsapod_2018_raw_density_DOY20-80_LT4-11_16-23.png")
...
def main() -> None:
    ...
    fig.suptitle(
        "Swarm-A Raw Thermospheric Mass Density (2018, DOY 20–80)",
    ...
    for col, Z_data, title, sector, df_sec in panels:
        ...
        ax.set_xlabel("Day of Year 2018 (DOY 20–80)", fontsize=11)
