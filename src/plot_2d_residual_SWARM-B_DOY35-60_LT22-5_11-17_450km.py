...
目的:
    ...
    3. SWARM-B のLTセクター（22–05 LT / 11–17 LT）で contourf 表示
    4. SSW期間（DOY 41-60）をハイライト

出力:
    Figure/2018/2D_residual_SWARM-B_DOY35-60_LT22-5_11-17_450km.png
"""
...
OUT_PNG      = Path("Figure/2018/2D_residual_SWARM-B_DOY35-60_LT22-5_11-17_450km.png")
...
NIGHT_WRAPS  = True        # 夜側セクターが深夜をまたぐ
...
# =========================
def main() -> None:
    print("Loading normalized data (SWARM-B, DOY 35-60) ...")
    ...
    fig.suptitle(
        "Swarm-B  Residual Normalized Density (DOY 35–60, 2018)\n"
        "Reference: DOY 35–40 mean per latitude (non-SSW, ref: 450 km)",
    ...
    for col, Z_res, df_sec, sector, title in panels:
        ...
        if sector == SECTOR_NIGHT and NIGHT_WRAPS:
            ax_r.set_ylim(22, 29)
