...
出力:
    Figure/residual_density_SWARM-B.png
"""
...
# 設定
# =========================
NORM_PARQUET = Path("normalizeddata/swarm_dnsbpod_2018_normalized.parquet")
COSMIC_CSV   = Path("cosmic_T10hPa_daily_2018_DOY032_050_lat60_90N.csv")
OUT_PNG      = Path("Figure/residual_density_SWARM-B.png")
...
# 正規化密度 読み込み
# =========================
print("Loading normalized density (SWARM-B) ...")
...
plt.title(
    f"Swarm-B Residual Density & COSMIC T(10 hPa)  [DOY {DOY_START}–{DOY_END}, 2018]\n"
