...
出力:
    Figure/2018/residual_density_SWARM-C.png
"""
...
OUT_PNG      = Path("Figure/2018/residual_density_SWARM-C.png")
...
# 正規化密度 読み込み
# =========================
print("Loading normalized density (SWARM-C) ...")
...
plt.title(
    f"Swarm-C Residual Density & COSMIC T(10 hPa)  [DOY {DOY_START}–{DOY_END}, 2018]\n"
