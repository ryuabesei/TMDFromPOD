"""
DOY_Daily_Density_before_after_SWARM-A.py
...
OUT_PNG      = Path("Figure/2018/DailyDensity_before_after_SWARM-A_DOY20-80.png")
...
ax.set_title(
    "Swarm-A: Daily Mean Density – Before vs After Normalization\n"
