"""
plot_1D_ratio_with_temp_2019_by_LT_extended.py
...
Purpose:
    ...
    split by LT sector for SWARM-A, B, C during the 2019 SH SSW, extended to 2019-10-31.
...
Output:
    Figure/2019/1D_ratio_with_temp_2019_SWARM-{A,B,C}_by_LT_extended.png
"""
...
SATELLITES = [
    dict(
        ...
        out_png    = Path("Figure/2019/1D_ratio_with_temp_2019_SWARM-A_by_LT_extended.png"),
    ...
    dict(
        ...
        out_png    = Path("Figure/2019/1D_ratio_with_temp_2019_SWARM-B_by_LT_extended.png"),
    ...
    dict(
        ...
        out_png    = Path("Figure/2019/1D_ratio_with_temp_2019_SWARM-C_by_LT_extended.png"),
        lt_sectors = LT_DAWN_DUSK,
    ),
]

DATE_START = pd.Timestamp("2019-08-20", tz="UTC")
DATE_END   = pd.Timestamp("2019-10-31", tz="UTC")
...
def plot_satellite(sat: dict, df_temp: pd.Series) -> None:
    ...
    fig.suptitle(f"{label}  density_ratio_msis with Stratospheric Temp (2019 SH SSW - Extended)\n{lt_names}",
