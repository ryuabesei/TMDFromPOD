...
OUT_PNG      = Path("Figure/2018/2D_residual_SWARM-C_DOY20-80.png")
...
# =========================
def main() -> None:
    print("Loading normalized data (SWARM-C, DOY 20-80) ...")
