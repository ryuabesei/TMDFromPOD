...
Purpose:
    ...
    from Swarm-B normalized density data (ref alt ~450 km), with COSMIC T(10 hPa) overlay.
    Analysis period narrowed to DOY 35-60 to reduce LT-width variation.

Steps:
    1. Load Swarm-B normalized density (from DOY20-80 parquet, filter to DOY 35-60)
    2. Filter by lat (-60 to 60) and LT sector (Night 22-05 LT / Day 11-17 LT)
...
def plot_residuals(
    ...
    fig.suptitle(
        ...
        "Reference: mean over non-SSW period (DOY 35–40, ref: 450 km)  [LT: 22–05 / 11–17]",
