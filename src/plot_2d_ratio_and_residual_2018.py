"""
plot_2d_ratio_and_residual_2018.py
...
Purpose:
    ...
    for SWARM-A, B, C during 2018 SSW period (DOY 20-80).

    LT sectors per satellite (with representative LT lines):
      SWARM-A/C: Morning (4-11 LT) / Evening (16-23 LT)
      SWARM-B:   Nightside (22-05 LT, wrapped) / Dayside (11-17 LT)

Output:
    Figure/2018/2D_ratio_and_residual_2018_SWARM-{A,B,C}.png
"""
...
SATELLITES = [
    dict(
        ...
        out_png       = Path("Figure/2018/2D_ratio_and_residual_2018_SWARM-A.png"),
        sec1          = (4, 11),
        sec2          = (16, 23),
        sec1_wrap     = False,
    ...
    dict(
        ...
        out_png       = Path("Figure/2018/2D_ratio_and_residual_2018_SWARM-B.png"),
        sec1          = (22, 5),
        sec2          = (11, 17),
        sec1_wrap     = True,
    ...
    dict(
        ...
        out_png       = Path("Figure/2018/2D_ratio_and_residual_2018_SWARM-C.png"),
        sec1          = (4, 11),
        sec2          = (16, 23),
        sec1_wrap     = False,
        sec1_title    = "Morning (04–11 LT)",
...
def plot_satellite(sat: dict) -> None:
    ...
    # LT線のオーバーレイ関数
    def overlay_lt_line(ax: plt.Axes, df_sec: pd.DataFrame, sec: tuple[float, float], wrap: bool) -> None:
        ax_r = ax.twinx()
    ...
    ax10.set_xlabel("Day of Year 2018 (DOY 20-80)", fontsize=11, fontweight="bold")
    ...
    ax11.set_xlabel("Day of Year 2018 (DOY 20-80)", fontsize=11, fontweight="bold")
    ...
    fig.suptitle(
        f"{label}  density_ratio_msis (DOY 20\u201380, 2018)\n"
...
def main() -> None:
    for sat in SATELLITES:
        plot_satellite(sat)
    print("\n✅ All 2D ratio and residual plots completed.")
