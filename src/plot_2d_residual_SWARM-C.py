...
出力:
    Figure/2018/2D_residual_SWARM-C.png
"""
...
OUT_PNG      = Path("Figure/2018/2D_residual_SWARM-C.png")
...
# =========================
def main() -> None:
    print("Loading normalized data (SWARM-C) ...")
    ...
    fig.suptitle(
        "Swarm-C  Residual Normalized Density (DOY 36–52, 2018)\n"
