...
Purpose:
    ...
    This version uses extended LT sectors (Morning: 04-14, Evening: 16-24 LT)
    to accommodate the precession of Swarm-A's orbit during DOY 20-80.
...
Output:
    Figure/2018/1D_residual_SWARM-A_DOY20-80_extendedLT.png
"""
...
OUT_PNG       = Path("Figure/2018/1D_residual_SWARM-A_DOY20-80_extendedLT.png")

DOY_START, DOY_END = 20, 80          # analysis range
LAT_MIN, LAT_MAX   = -60.0, 60.0    # latitude filter

SECTOR_MORNING = (4, 14)            # Morning (extended)
SECTOR_EVENING = (16, 24)           # Evening (extended)
...
def plot_residuals(
    ...
    sectors = [
        (axes[0], res_morning, ref_morning, "Morning (04–14 LT)", "#2A6AE0"),
        (axes[1], res_evening, ref_evening, "Evening (16–24 LT)", "#E05C2A"),
    ]
