...
入力:
- integrateddata/swarm_dnscpod_2018.parquet
...
# 入出力パス（ユーザー指定）
# =========================
SWARM_PARQUET = Path("integrateddata/swarm_dnscpod_2018.parquet")
KPINDEX_CSV   = Path("data/Kpindex/SW-All.csv")
OUT_PARQUET   = Path("normalizeddata/swarm_dnscpod_2018_normalized.parquet")
