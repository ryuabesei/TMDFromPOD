"""
plot_msis_correlations_3years.py
...
Purpose:
    ...
    - Ap Index (AP_AVG)
    - F10.7 (F107)
    For 2018 NH SSW (SWARM-A), 2019 SH SSW (SWARM-A), and 2021 NH SSW (SWARM-C).
"""
...
def generate_analysis_plots(parquet_path: Path, year: int, doy_range: tuple[int, int] | None, out_png: Path, label: str):
...
def main():
    generate_analysis_plots(P2018, 2018, (30, 65), OUT_DIR / "msis_activity_correlation_2018.png", "SWARM-A 2018 (NH SSW)")
    generate_analysis_plots(P2019, 2019, None, OUT_DIR / "msis_activity_correlation_2019.png", "SWARM-A 2019 (SH SSW)")
    generate_analysis_plots(P2021, 2021, None, OUT_DIR / "msis_activity_correlation_2021.png", "SWARM-C 2021 (NH SSW)")
