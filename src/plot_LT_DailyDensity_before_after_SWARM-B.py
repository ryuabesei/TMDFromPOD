...
SECTOR_1 = (22, 5)   # Night
SECTOR_2 = (11, 17)  # Day
SECTOR_1_LABEL = "Night (22–05 LT)"
SECTOR_2_LABEL = "Day (11–17 LT)"
MORNING_WRAPS = True
...
def main():
    ...
    # Filter by sectors
    raw_s1 = filter_sector(df_raw, SECTOR_1[0], SECTOR_1[1], MORNING_WRAPS)
    raw_s2 = filter_sector(df_raw, SECTOR_2[0], SECTOR_2[1], False)
    
    norm_s1 = filter_sector(df_norm, SECTOR_1[0], SECTOR_1[1], MORNING_WRAPS)
